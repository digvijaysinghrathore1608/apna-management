...
@section('content')
    <div class="card p-3 mb-2">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="mb-0">{{ translate('customers') }}</h5>
            <div>
                <a href="{{ route('microfinance.customers.create') }}" class="btn btn-primary btn-sm">Add New</a>
    ...
    ]" :ajax="route('microfinance.customers.index')" />
@endsection
